'''
The main purpose of this program is to pair neurons imaged by two-photon imaging and HD-fMOST imaging
The parameter file of the program is in parameter.py
'''
...
from Neuron_Detection.predict import detection
from parameter import *
from Neuron_Matching.data_matching import get_matching
from utils.data_analyse import data_analyse
from utils.func import get_closest_points_res
from utils.func0 import get_transmat
from utils.get_data import *
from utils.get_image import get_matching_results
...
def run():
    ...
    for file_name in os.listdir(two_photon_dir):
        if file_name.endswith('csv'):
            ...
            res = get_matching(tasks, two_photon_data, data0, thickness, theta, step0)
            ...
            res1 = get_matching(tasks1, two_photon_data, data0_trans1, thickness, theta, step0)
            ind1, ind2, r1, t1, r_x1, r_y1 = res1
            data0_trans2 = data0_trans1.dot(r1) + t1
            res_index = get_closest_points_res(data0_trans2[:, :2], two_photon_data, distance_thread=15)
