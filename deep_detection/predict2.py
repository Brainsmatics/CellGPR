...
from predict_dataset1 import predict_dataset
...
if __name__ == "__main__":
    # a = detection(image_path='./test_data/data4.tif', model_path='saved_model/270_0.pth', thread_distance=5,
    #               thread_conf=0.01, batch_size=1)
    a = detection(image_path=r'G:\item\neuron_matching_v2\graph\neuron_detector\Level2_large.tif', model_path='saved_model_3/60.pth', thread_distance=8,
                  thread_conf=0.3, batch_size=1)
    a.run()