...
from soma_matching.methods.MPM_3 import MPM_2
...
class data_matching:
    ...
    def get_max_matching(self, r_x, r_y, z_min):
        ...
        if len(data_2d_index) >= 3:
            ...
            method = MPM_2(self.data1, data2_2d_tmp, self.theta)
            index, _ = method.run()
            ...
            if nums1 >= 3:
                ...
                method1 = MPM_2(data10, data20, self.theta)
                _, match_score = method1.run()
