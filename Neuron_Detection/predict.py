# We use this script to predict the neuron somas in the image. The predicted somas are saved in the swc format and the labeled image. The labeled image is saved in the tif
import sys
...
from Neuron_Detection.feature_extract_net import Model_net
import torch.backends.cudnn as cudnn
import os
from torchvision import transforms
from Neuron_Detection.predict_dataset import predict_dataset
...
class detection:
    ...
    def non_max_suppression(self, pred, conf_thres=0.5, distance_thres=12):
        ...
        while pred0.size(0):
            ...
            # a detection that is too close to the max detection
    ...
    def non_max_suppression_total(self, detection_list, distance_thres=12):
        ...
        while detection0.size(0):
            ...
            # remove the detection that is too close to the max detection
    ...
    def run(self):
        ...
        # do non max suppression for all detection
